...
export default function RoulettePatternsPanel({ signal, nextSignalIn = null }) {
  ...
  const getSignalStyles = () => {
    ...
    switch (signal.type) {
      case 'STRONG_SIGNAL':
        return { ...baseStyle, borderColor: '#00ff00', backgroundColor: '#f0fff0' };
      case 'MEDIUM_SIGNAL':
        return { ...baseStyle, borderColor: '#ffff00', backgroundColor: '#fffef0' };
      default:
        return { ...baseStyle, borderColor: '#ffa500', backgroundColor: '#fff5e6' };
    }
  };
